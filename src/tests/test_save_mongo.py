from framework import SaveHandlerMongo
import unittest
...
class TestSave(unittest.TestCase):
    def setUp(self) -> None:
        self.save_handler = SaveHandlerMongo("unittest")
    ...
    def test_save_result(self):
        ...
        doc = self.save_handler.res_collection.find_one(
            result.info, {"_id": 0})
    ...
    def test_find(self):
        ...
        self.assertEqual([r.info['result_index']
                         for r in results], result_indices)
