...
class SaveHandler:
    def __init__(self, path):
        """
        Class for saving and loading algorithm instances and results. This class is used by
        ``Algorithm`` to save and load instances and results.
        
        Parameters
        ----------
        path : string
            The path to the folder where the instances and results of the algorithm
            will be saved.
        """
        self.path = path
