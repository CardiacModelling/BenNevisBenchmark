...
# run_grid_search()
points_list, function_values, distance_values, downsampling = read_results(f'simulated_annealing_9_')

# points_list, function_values, distance_values, downsampling = read_results(f'grid_search_{GRID_SIDE}_{GRID_DOWNSAMPLING}_')
t = nevis.Timer()
plot_random_method(points_list, function_values, distance_values, method_name='Simulated Annealing', downsampling=downsampling)
print(t.format())
plt.show()